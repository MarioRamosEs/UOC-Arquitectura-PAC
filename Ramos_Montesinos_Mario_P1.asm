...
getSecretPlayP1: ;prefix sp_
   ...
   ;check state_2 - Decidimos en que array hay que guardar el valor dependiendo del estado.
   cmp DWORD[state], 0
   je sp_state0_2
   sp_stateNot0_2:
...
checkPlayP1: ;prefix cp_
   ...
   ;Comprobación de hitsx con DimVector para cambiar o no el estado
   cmp al, DimVector 
   jne cp_endIf
   mov DWORD[state], 5
   cp_endIf:
...
printSecretP1: ;prefix ps_
   ...
   mov DWORD[rowScreen], 3
   mov DWORD[colScreen], 8
   mov ebx, 8 ;ebx will be colScreen. Se usa como variable burbuja porque al pintar, el valor de colScreen cambia.
